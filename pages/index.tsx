      ...
      <section id='intro'>
        <div className='header'>
          ...
          <div className='button-options'>
            ...
            <button
              onClick={() =>
                window.open('https://discord.gg/kZkT9ZK', '_blank')
              }
            ...
            <div className='wave-1'>
              <div className='wave-container'>
                <svg
                  ...
                  // enableBackground='new 0 0 2033 289.3'
                >
            ...
            <div className='wave-2'>
              <div className='wave-container'>
                <svg
                  ...
                  // style='enable-background:new 0 0 2211.1 161.6;'
                >
            ...
            <div className='wave-3'>
              <div className='wave-container'>
                <svg
                  ...
                  // style='enable-background:new 0 0 2410 66.2;'
                >
                ...
                <div id='value-attribution-animation'>
                  <div className='wave-1'>
                    <svg
                      ...
                      height='289.3px'
                      viewBox='0 0 2033 289.3'
                      // style='enable-background:new 0 0 2033 289.3;'
                    >
                      <path d='M0,0.6c169.4,0,169.4,270.1,338.8,270.1c169.4,0,169.4-255.6,338.8-255.6c169.4,0,169.4,231,338.8,231 c169.4,0,169.4-168.5,338.8-168.5c169.4,0,169.4,211,338.8,211c169.4,0,169.4-288.1,338.9-288.1' />
                    </svg>
                  </div>
            ...
            <div className='column'>
              <div className='animation'>
                <div id='value-monetization-animation'>
                  <svg
                    className='preexisting'
                    aria-hidden='true'
                    height='43.3'
                    viewBox='0 0 58.6 43.3'
                    width='58.6'
                    xmlns='http://www.w3.org/2000/svg'
                  >
            ...
            <div className='column'>
              <div className='description teal'>
                ...
                <p>
                  ...
                  Audius is entirely driven by $AUDIO governance. Everything
                  about Audius is governable, with voting weight directly
                  correlated to $AUDIO staked for value-added services.
                </p>
              </div>
            </div>
          </div>
