                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        fillRule='evenodd'
                        clipRule='evenodd'
                        d='M8.37507 2.57029C10.0259 2.47657 14.9741 2.47657 16.6249 2.57029C18.2267 2.65062 19.6456 3.01657 20.8146 4.18582C21.988 5.35507 22.3539 6.77424 22.4297 8.37638C22.5234 10.0276 22.5234 14.9724 22.4297 16.6236C22.3494 18.2258 21.9835 19.6449 20.8146 20.8142C19.6456 21.9879 18.2267 22.3538 16.6249 22.4297C14.9741 22.5234 10.0259 22.5234 8.37507 22.4297C6.77328 22.3494 5.3589 21.9834 4.18544 20.8142C3.01199 19.6449 2.64612 18.2258 2.57027 16.6236C2.47658 14.9724 2.47658 10.0232 2.57027 8.37192C2.65059 6.76978 3.01199 5.35061 4.18544 4.18136C5.3589 3.01211 6.77775 2.64616 8.37507 2.57029ZM12.5 6.875C9.38642 6.875 6.875 9.38642 6.875 12.5C6.875 15.6136 9.38642 18.125 12.5 18.125C15.6136 18.125 18.125 15.6136 18.125 12.5C18.125 9.38642 15.6136 6.875 12.5 6.875ZM12.5 8.75C14.5683 8.75 16.25 10.4317 16.25 12.5C16.25 14.5683 14.5633 16.25 12.5 16.25C10.4367 16.25 8.75 14.5683 8.75 12.5C8.75 10.4317 10.4317 8.75 12.5 8.75ZM18.125 5.625C17.4347 5.625 16.875 6.1847 16.875 6.875C16.875 7.5653 17.43 8.125 18.125 8.125C18.8153 8.125 19.375 7.56996 19.375 6.875C19.375 6.1847 18.8153 5.625 18.125 5.625Z'
                        fill='#12063D'
                      />
                    </svg>
                    <span>Instagram</span>
        ...
        <div className='sign-off'>
          <p className='copyright'>
            <span className='mobile-break'>
              © {new Date().getFullYear()} Open Audio Foundation. All Rights
              Reserved.
            </span>
          </p>
        </div>
